...
Goal: 
When comparing two numbers which we give to the function maxOtTwoNumbers, the higher number should be displayed.

Step 1: make an if-statement to check whether num1 > num2. If yes, console.log and return num1.

Step 2: make an else-statement which should return and console.log num2,
...
First step: We declare a let variable sum and initialize it with 0.

Second step: we take the .forEach method for the numbers array. For each element in the array numbers, we want to add the number with the variable sum and also want 
...
/*
First step: We want to get the length of each array element. 

Second step: We want to sum up the length of all array elements and divide it by the length of the array words2.

Third step: We want to divide the sum with the length of the words2numbers Array.

Final step: We call the function averageWordLength(words2);
