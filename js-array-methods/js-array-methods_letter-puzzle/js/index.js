...
const employeesSortedByAge = employees.toSorted((employeeA, employeeB) => {
...
// const test = employees.some((employee) => employee.lastName.startsWith("Z") );

// console.log(test);

const employeesSortedByLastName = employees.toSorted((employeeA, employeeB) => {

  const lastNameA = employeeA.lastName.toLowerCase();
  const lastNameB = employeeB.lastName.toLowerCase();
