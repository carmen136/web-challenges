...
export default function App() {
  ...
  return <div>
            ...
            isDisabled = {false}
            text = "Danger!"
            onButton = {() => handleButton("Danger!")} />
            <Button 
            backgroundColor = "yellow"
            isDisabled = {false}
            text = "Please fill in the form correctly."
            onButton = {() => handleButton("Congrats! You filled in the form correctly")} />
         </div>
}


function Button({backgroundColor, text, isDisabled, onButton}) {
  return (
    <button onClick = {onButton} type="button" disabled= {isDisabled} style={{backgroundColor: backgroundColor}}>
      {text}
    </button>
  )
}
